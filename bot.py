...
OPENAI_API_KEY     = "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"
...
<body>
  <div class="card">
    <div class="header">
      <h1>📊 XAUUSD AI Bot</h1>
      <p>Powered by ChatGPT GPT-4o + Yahoo Finance</p>
      <div class="badge">
        <span class="dot"></span>
        {icon} {status.upper()}
      </div>
