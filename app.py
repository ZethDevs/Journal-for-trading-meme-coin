...
def load_saldo():
    """Load saldo history from text file"""
    if not os.path.exists(SALDO_FILE):
        # Default saldo data if file doesn't exist
        default_saldo = {
            "saldo_awal": 5000000,
            "transaksi": [
                {"tanggal": "2024-01-01", "saldo": 5000000},
                {"tanggal": "2024-01-15", "saldo": 5150000},
                {"tanggal": "2024-01-20", "saldo": 5100000},
                {"tanggal": "2024-01-25", "saldo": 5400000}
            ]
        }
    ...
    try:
        ...
        return {"saldo_awal": 5000000, "transaksi": []}
...
def calculate_total_saldo():
    ...
    today_exists = any(t['tanggal'] == today for t in saldo_data['transaksi'])
...
def add_trade():
    ...
    try:
        ...
        # Generate new ID
        new_id = max([item['id'] for item in trades], default=0) + 1
